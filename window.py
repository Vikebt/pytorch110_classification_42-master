...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model_path = "../checkpoints/resnet50d_pretrained_224/resnet50d_10epochs_accuracy0.99093_weights.pth"  # todo  模型路径
        # “雏菊”、“蒲公英”、“玫瑰”、“向日葵”、“郁金香”
        self.classes_names = ['雏菊', '蒲公英', '玫瑰', '向日葵', '郁金香']  # todo 类名
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        *** 关于界面 ***
        ...
        label_super.setText("<a href='https://zhoucong.top'>或者你可以在这里找到我-->Vikebt</a>")
